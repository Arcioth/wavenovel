...
I wanted to make a custom version of wavenovel as it was "lacking" in some places such as the UI in my case and decided to take this approach. Its fairly an upgrade to wacemaker but I plan on improving this further by adding zen mode and image support.
